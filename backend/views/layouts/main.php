...
/* @var $content string */
$skin_color = isset(Yii::$app->assetManager->bundles['dmstr\web\AdminLteAsset']['skin']) ? Yii::$app->assetManager->bundles['dmstr\web\AdminLteAsset']['skin'] : ''; // ->skin ;
 ...
 */
	...
	*/
    ...
    <body class="<?= $skin_color ?> sidebar-mini">
    <?php $this->beginBody() ?>
    <div class="wrapper">
