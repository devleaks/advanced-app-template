...
$this->title = Yii::t('app', 'Restore Database from Backup of Production');
...
<div class="backup-index">
	...
	<div class="alert alert-warning">
		<?= Yii::t('app', 'Database file {0} not found.', $dbfile) ?>
	</div>
	<?php endif; ?>
	
	<?php if(!file_exists($mediafile)): ?>
	<div class="alert alert-warning">
		<?= Yii::t('app', 'Media file {0} not found.', $mediafile) ?>
	</div>
	<?php endif; ?>
    ...
    <?= Html::submitButton('<i class="glyphicon glyphicon-warning-sign"></i> '.Yii::t('app', 'Restore Database from Backup of Production'), ['class' => 'btn btn-lg btn-danger']) ?>
